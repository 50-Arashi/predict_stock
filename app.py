...
st.write('※あくまでAiによる予想です（参考値）。こちらのアプリによる被害や損失は一切補償しかねます。')
st.header("株価銘柄のティッカーシンボルを入力して下さい。")
...
link='https://search.sbisec.co.jp/v2/popwin/info/srock/pop6040_usequity_list.html'
st.markdown(link)
...
try:
    ...
    st.header(stock_name_full+"終値と14年間平均（USD）")
    ...
    st.header(stock_name_full + '1か月を予測しよう（USD）')
    def stock_predict():
